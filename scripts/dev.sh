...
# Chat Service - Run with direct RabbitMQ (local development)

echo "Starting Chat Service (Direct RabbitMQ)..."
echo "Service will be available at: http://localhost:8013"
echo ""

# Kill any process using port 8013 (prevents "address already in use" errors)
PORT=8013
